...
1. **OpenResty Container**: Runs OpenResty with RouteWarden directly mounted/copied from the local library (`samples/Dockerfile`) and exposes 14 dedicated test ports mapped in `samples/nginx.conf`.
